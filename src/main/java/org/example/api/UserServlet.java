...
public class UserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        objectMapper.writeValue(resp.getWriter(), userService.getUserById(UUID.fromString(parts[1])));
    }
    @Override
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        userService.deleteUser(UUID.fromString(parts[1]));
    }
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (pathInfo == null || pathInfo.equals("/")) {
            ...
            objectMapper.writeValue(resp.getWriter(), userService.updateUser(id, dto));
        } else {
            resp.sendError(HttpServletResponse.SC_BAD_REQUEST, "Invalid url");
        }
